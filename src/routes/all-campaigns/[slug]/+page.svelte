<script lang="ts">    
  ...
  async function handleEventChanges(building_id: number, new_email: string, new_phone: string){
              ...
              <Body>
                  ...
                  <Row>
                      ...
                      <Cell class='cell-align' numeric>
                        <TextField class='cell-align' bind:value={item.email}></TextField>
                      </Cell>
                      <Cell class='cell-align' numeric>
                        <TextField class='cell-align' bind:value={item.phone_number}></TextField>
                      </Cell>
                      ...
                      <Cell class='cell-align' numeric>
                        <Button on:click={() => handleEventChanges(item.building_id, item.email, item.phone_number)}>Save Changes</Button>
                    </Cell>
                  </Row>
                  {/each}
              </Body>
